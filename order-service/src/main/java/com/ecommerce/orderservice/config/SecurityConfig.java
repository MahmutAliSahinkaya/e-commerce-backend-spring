...
import com.ecommerce.orderservice.jwt.JwtAccessDeniedHandler;
import com.ecommerce.orderservice.jwt.JwtAuthenticationEntryPoint;
import com.ecommerce.orderservice.jwt.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/carts/**").hasRole("USER")
